...
$insert_admin = "insert into admins (admin_name,admin_email,admin_pass,admin_contact,admin_country,admin_job) values ('$admin_name','$admin_email','$hashed_admin_pass','$admin_contact','$admin_country','$admin_job')";
