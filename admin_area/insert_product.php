...
$insert_product = "insert into products (cat_id,product_title,product_url,product_img1,product_price,product_desc,product_features,product_keywords) values ('$cat','$product_title','$product_url','$product_img1','$product_price','$product_desc','$product_features','$product_keywords')";
