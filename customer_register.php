...
$hashed_c_pass = password_hash("$c_pass", PASSWORD_DEFAULT);
...
$insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$hashed_c_pass','$c_country','$c_city','$c_contact','$c_address','$c_ip','$customer_confirm_code')";
