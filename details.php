...
<img src="admin_area/product_images/<?php echo $pro_img1; ?>" class="product_image">
...
<label class="col-md-5 control-label" >Coffee Quantity </label>
...
Coffee Price : <del> $$pro_price </del><br>
